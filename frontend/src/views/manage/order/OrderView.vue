<template>
  <a-modal v-model="show" title="用户会员订单详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="recordData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>会员开始时间：</b>
          {{ recordData.startDate ? recordData.startDate : '- -' }}
        </a-col>
        <a-col :span="8"><b>会员结束时间：</b>
          {{ recordData.endDate ? recordData.endDate : '- -' }}
        </a-col>
      </a-row>
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col :span="8"><b>会员类型：</b>
          {{ recordData.ruleName }}
        </a-col>
        <a-col :span="8"><b>价格：</b>
          {{ recordData.price }} 元
